...
The committed `overlap_nvtx_minimal.png` is currently a manually curated Nsight timeline screenshot (single-panel). Keep this filename stable so paper include paths do not change.
...
- `overlap_nvtx_minimal.png` (results section timeline evidence)
